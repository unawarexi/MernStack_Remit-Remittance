...
// Define interfaces for image props
interface LogoProps {
  src1: string;
  src2: string;
  src3: string;
...
function Partners() {
  // Example usage with imported images
  const klarnaLogo: LogoProps = {
    src1: Klarna,
    src2: Stripe,
    src3: PayPal,
    alt1: "Klarna logo",
